...
## Purpose
Defines the lexer, parser, and validator for `@server` DSL blocks, covering HTTP route directives, path pattern parsing, middleware support, and validation rules for server templates.

...
## Purpose
Defines the handler for `@component` DSL blocks, covering JSX parsing via SWC, export default validation, JSDoc-based prop type extraction, and component metadata generation.

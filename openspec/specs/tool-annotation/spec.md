...
## Purpose
Defines the `@tool` annotation syntax for marking functions as tool-callable, covering parser recognition, AST representation, ordering with modifiers, checker registration, and serializability validation.

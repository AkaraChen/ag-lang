...
## Purpose
Defines the lexer, parser, and validator for `@skill` DSL blocks, covering directive recognition for description, input, steps, and output sections, along with AST generation and validation rules.

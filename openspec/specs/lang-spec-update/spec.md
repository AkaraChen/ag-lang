# Language Spec Update (v0.2)

## Purpose
Defines the updates to the AgentScript language specification to incorporate DSL blocks, extern declarations, the annotation system, and revised sections for agents, tools, skills, components, servers, stdlib, grammar, and compilation.
